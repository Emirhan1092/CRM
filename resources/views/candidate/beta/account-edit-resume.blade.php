                ...
                <div class="section-incremental-form-alpha front-resume-general-section">
                    ...
                    <div class="collapse" id="generalSection" style="">
                        <div class="card card-body collapsed-card">
                            @include('candidate.beta.partials.account-edit-resume-general')
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card card-body collapsed-card">
                            <form class="form" id="resume_edit_experiences_form">
                                ...
                                <div class="section-container">
                                    ...
                                    @include('candidate.beta.partials.account-edit-resume-experiences')
                                    @endforeach
                                </div>
                                <div class="row">
                        ...
                        <div class="card card-body collapsed-card">
                            <form class="form" id="resume_edit_qualifications_form">
                                ...
                                <div class="section-container">
                                    ...
                                    @include('candidate.beta.partials.account-edit-resume-qualifications')
                                    @endforeach
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="card card-body collapsed-card">
                            <form class="form" id="resume_edit_achievements_form">
                                ...
                                <div class="section-container">
                                    ...
                                    @include('candidate.beta.partials.account-edit-resume-achievements')
                                    @endforeach                                    
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="card card-body collapsed-card">
                            <form class="form" id="resume_edit_skills_form">
                                ...
                                <div class="section-container">
                                    ...
                                    @include('candidate.beta.partials.account-edit-resume-skills')
                                    @endforeach
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="card card-body collapsed-card">
                            <form class="form" id="resume_edit_languages_form">
                                ...
                                <div class="section-container">
                                    ...
                                    @include('candidate.beta.partials.account-edit-resume-languages')
                                    @endforeach
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
                        ...
                        <div class="card card-body collapsed-card">
                            <form class="form" id="resume_edit_references_form">
                                ...
                                <div class="section-container">
                                    ...
                                    @include('candidate.beta.partials.account-edit-resume-references')
                                    @endforeach                                    
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-lg-12">
