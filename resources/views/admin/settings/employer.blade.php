            ...
            <div class="card card-default">
                ...
                <form id="admin_employer_settings_form" method="post">
                    ...
                    <div class="row">
                        ...
                        $temp7 = route('uploads-view', 'employer-email-templates/job-application-status-change.html');
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea rows="20" class="form-control" name="job_application_status_change" id="job_application_status_change">{!! setting('job_application_status_change') !!}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
