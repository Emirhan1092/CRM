            ...
            <div class="card card-default">
                ...
                <form id="admin_apis_form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <hr />
                            <img src="{{ url('/cdn-employers') }}/img/paypal.png" height="50" />
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <hr />
                            <img src="{{ url('/cdn-employers') }}/img/stripe.png" height="50" />
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <hr />
                            <img src="{{ url('/cdn-employers') }}/img/paystack.png" height="50" />
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <hr />
                            <img src="{{ url('/cdn-employers') }}/img/razorpay.png" height="50" />
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <hr />
                            <img src="{{ url('/cdn-employers') }}/img/flutterwave.png" height="50" />
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.enable_flutterwave')}}</label><br />
                                <input type="radio" class="minimal" name="enable_flutterwave" value="yes" 
                                {{sel(setting('enable_flutterwave'), 'yes', 'checked')}}>
                                <strong>{{__('message.yes')}}</strong>&nbsp;&nbsp;&nbsp;
                                <input type="radio" class="minimal" name="enable_flutterwave" value="no"
                                {{sel(setting('enable_flutterwave'), 'no', 'checked')}}>
                                <strong>{{__('message.no')}}</strong>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.flutterwave_public_key')}}</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.flutterwave_secret_key')}}</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.flutterwave_encryption_key')}}</label>
                                <input type="text" class="form-control" name="flutterwave_encryption_key"  
                                value="{{setting('flutterwave_encryption_key')}}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <hr />
                            <img src="{{ url('/cdn-employers') }}/img/mollie.png" height="50" />
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.enable_mollie')}}</label><br />
                                <input type="radio" class="minimal" name="enable_mollie" value="yes" 
                                {{sel(setting('enable_mollie'), 'yes', 'checked')}}>
                                <strong>{{__('message.yes')}}</strong>&nbsp;&nbsp;&nbsp;
                                <input type="radio" class="minimal" name="enable_mollie" value="no"
                                {{sel(setting('enable_mollie'), 'no', 'checked')}}>
                                <strong>{{__('message.no')}}</strong>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.mollie_environment')}}</label><br />
                                <input type="radio" class="minimal" name="mollie_environment" value="testing" 
                                {{sel(setting('mollie_environment'), 'testing', 'checked')}}>
                                <strong>{{__('message.testing')}}</strong>&nbsp;&nbsp;&nbsp;
                                <input type="radio" class="minimal" name="mollie_environment" value="live"
                                {{sel(setting('mollie_environment'), 'live', 'checked')}}>
                                <strong>{{__('message.live')}}</strong>
                            </div>
                        </div>                        
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.mollie_live_api_key')}}</label>
                                <input type="text" class="form-control" name="mollie_live_api_key" 
                                value="{{setting('mollie_live_api_key')}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.mollie_test_api_key')}}</label>
                                <input type="text" class="form-control" name="mollie_test_api_key"  
                                value="{{setting('mollie_test_api_key')}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.mollie_profile_id')}}</label>
                                <input type="text" class="form-control" name="mollie_profile_id"  
                                value="{{setting('mollie_profile_id')}}">
                            </div>
                        </div>                        
                        <div class="col-md-12">
                            <br />
                            <img src="{{ url('/cdn-employers') }}/img/gmail.png" height="50" />
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <br />
                            <img src="{{ url('/cdn-employers') }}/img/recaptcha.png" height="100" />
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.recaptcha_enable_on_login')}}</label><br />
                                <input type="radio" class="minimal" name="recaptcha_enable_on_login" value="yes" 
                                {{sel(setting('recaptcha_enable_on_login'), 'yes', 'checked')}}>
                                <strong>{{__('message.yes')}}</strong>&nbsp;&nbsp;&nbsp;
                                <input type="radio" class="minimal" name="recaptcha_enable_on_login" value="no"
                                {{sel(setting('recaptcha_enable_on_login'), 'no', 'checked')}}>
                                <strong>{{__('message.no')}}</strong>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.recaptcha_enable_on_register')}}</label><br />
                                <input type="radio" class="minimal" name="recaptcha_enable_on_register" value="yes" 
                                {{sel(setting('recaptcha_enable_on_register'), 'yes', 'checked')}}>
                                <strong>{{__('message.yes')}}</strong>&nbsp;&nbsp;&nbsp;
                                <input type="radio" class="minimal" name="recaptcha_enable_on_register" value="no"
                                {{sel(setting('recaptcha_enable_on_register'), 'no', 'checked')}}>
                                <strong>{{__('message.no')}}</strong>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.recaptcha_site_key')}}</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.recaptcha_secret_key')}}</label>
                        ...
                        <div class="col-md-12">
                            <hr />
                            <img src="{{ url('/cdn-employers') }}/img/linkedin.png" height="50" />
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
...
<script src="{{url('admins')}}/js/cf/setting.js"></script>
@endsection