            ...
            <div class="card card-default">
                ...
                <form id="admin_settings_form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{__('message.display_faq_categories')}}</label><br />
                                <input type="radio" class="minimal" name="display_faq_categories" value="yes" 
                                {{sel(setting('display_faq_categories'), 'yes', 'checked')}}>
                                <strong>{{__('message.yes')}}</strong>&nbsp;&nbsp;&nbsp;
                                <input type="radio" class="minimal" name="display_faq_categories" value="no"
                                {{sel(setting('display_faq_categories'), 'no', 'checked')}}>
                                <strong>{{__('message.no')}}</strong>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{__('message.timezone')}}</label><br />
                                <select class="form-control" name="timezone">
                                    @foreach(timezones() as $tz)
                                    <option value="{{$tz}}" {{sel(setting('timezone'), $tz, 'selected')}}>{{$tz}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{__('message.enable_delete_application_feature_for_candidate')}}</label><br />
                                <input type="radio" class="minimal" name="enable_delete_application_feature_for_candidate" value="yes" 
                                {{sel(setting('enable_delete_application_feature_for_candidate'), 'yes', 'checked')}}>
                                <strong>{{__('message.yes')}}</strong>&nbsp;&nbsp;&nbsp;
                                <input type="radio" class="minimal" name="enable_delete_application_feature_for_candidate" value="no"
                                {{sel(setting('enable_delete_application_feature_for_candidate'), 'no', 'checked')}}>
                                <strong>{{__('message.no')}}</strong>
                            </div>
                        </div>
                        <div class="col-md-4">
