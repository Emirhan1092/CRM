            ...
            <div class="card card-default">
                ...
                <form id="admin_email_form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{__('message.enable_emails_cron')}}</label><br />
                                <input type="radio" class="minimal" name="enable_emails_cron" value="yes" 
                                {{sel(setting('enable_emails_cron'), 'yes', 'checked')}}>
                                <strong>{{__('message.yes')}}</strong>&nbsp;&nbsp;&nbsp;
                                <input type="radio" class="minimal" name="enable_emails_cron" value="no"
                                {{sel(setting('enable_emails_cron'), 'no', 'checked')}}>
                                <strong>{{__('message.no')}}</strong>
                            </div>
                        </div>                        
                        <div class="col-md-6">
