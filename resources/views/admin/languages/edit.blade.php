    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                <form id="admin_language_messages_update_form" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <button type="submit" class="btn btn-primary" id="admin_language_messages_update_form_button">
                                {{__('message.update')}}
                            </button>
                        </div>
                        <!-- /.col -->
...
<script src="{{url('/admins')}}/js/cf/language.js"></script>
@endsection