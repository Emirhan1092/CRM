                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{__('message.news').' '.__('message.list')}}</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row dt-controls-row">
                                <div class="col-md-12">
                                    <div class="datatable-top-controls datatable-top-controls-filter">
                                        @if(allowedTo('create_news'))
                                        <button type="button" class="btn btn-info create-or-edit-news">
                                        <i class="fa fa-plus"></i> {{ __('message.create_news') }}
                                        </button>
                                        @endif
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                <a class="dropdown-item bulk-action" href="#" data-action="download-excel">{{ __('message.download_news_excel') }}</a>
                                            </div>
                                        </div>                                        
                                    </div>
                            ...
                            <table class="table table-bordered table-striped" id="news_datatable">
                                <thead>
                                    <tr>
...
<script src="{{url('admins')}}/js/cf/news.js"></script>
@endsection