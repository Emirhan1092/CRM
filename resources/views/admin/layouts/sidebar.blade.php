    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endif
                @if(allowedTo(array('home_page_settings', 'view_pages', 'view_faqs_listing', 'view_faqs_categories', 'view_news_listing', 'view_news_categories', 'menu_settings', 'view_testimonials', 'view_messages_listing', 'view_industries')))
                <li class="nav-item {{treeActive($menu, array('cms', 'setting-home', 'pages', 'news', 'news-categories', 'faqs', 'faqs-categories', 'menus', 'testimonials', 'messages', 'industries'))}}">
                    <a href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                        @if(allowedTo('view_industries'))
                        <li class="nav-item">
                            <a href="{{route('admin-industries')}}" class="nav-link {{acActive($menu, 'industries')}}">
                                &nbsp;<i class="fas fa-industry"></i>
                                <p>{{__('message.industries')}}</p>
                            </a>
                        </li>
                        @endif
                    </ul>
