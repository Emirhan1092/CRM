...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fas fa-cube"></i> {{ __('message.blog_categories') }}<small></small></h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/') }}/employer/dashboard"><i class="fas fa-tachometer-alt"></i> {{ __('message.home') }}</a></li>
            <li class="active"><i class="fas fa-blog"></i> {{ __('message.blogs') }}</li>
            <li class="active"><i class="fas fa-cube"></i> {{ __('message.categories') }}</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class="box">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="datatable-top-controls datatable-top-controls-filter">
                                    @if(empAllowedTo('create_blog_categories'))
                                    <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-blog-category">
                                    <i class="fa fa-plus"></i> {{ __('message.add_blog_category') }}
                                    </button>
                                    @endif
                                    <div class="btn-group">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped" id="blog_categories_datatable">
                            <thead>
                                <tr>
...
<script src="{{url('cdn-employers')}}/js/cf/blog_category.js"></script>
@endsection