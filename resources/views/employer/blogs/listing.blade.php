...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fas fa-blog"></i> {{ __('message.blogs') }}<small></small></h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                <div class="box">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="datatable-top-controls datatable-top-controls-filter">
                                    @if(empAllowedTo('create_blog'))
                                    <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-blog">
                                    <i class="fa fa-plus"></i> {{ __('message.add_blog') }}
                                    </button>
                                    @endif
                                    <div class="btn-group">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped" id="blogs_datatable">
                            <thead>
                                <tr>
...
<script src="{{url('cdn-employers')}}/js/cf/blog.js"></script>
@endsection