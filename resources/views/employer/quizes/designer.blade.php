                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title quiz-page-quizes-title">
                            ...
                            title="{{__('message.add_quiz')}}" data-id="">
                            <i class="fa fa-plus"></i>
                            </button>
                            @endif
                            ...
                            title="{{__('message.download_quiz_as_pdf')}}">
                            ...
                            <div class="col-md-8 col-sm-12">
                                <div class="input-group quiz-page-quiz-select-group">
                                    ...
                                    <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-quiz" 
                                        id="edit-quiz"
                                        title="{{__('message.edit_selected_quiz')}}">
...
<script src="{{url('cdn-employers')}}/js/cf/question.js"></script>
<script src="{{url('cdn-employers')}}/js/cf/quiz.js"></script>
<script src="{{url('cdn-employers')}}/js/cf/quiz_question.js"></script>
@endsection