...
<script src="{{url('cdn-employers')}}/js/cssbeautify.codemirror.js"></script>
<script src="{{url('cdn-employers')}}/js/cssbeautify.css.js"></script>
<script src="{{url('cdn-employers')}}/js/cssbeautify.js"></script>
