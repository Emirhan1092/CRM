                    ...
                    <form id="employer_settings_emails_form">
                        ...
                        <div class="box-body">
                            <div class="row">         
                                ...
                                $tags7 =  array('((first_name))','((last_name))','((job_title))','((application_status))', '((site_link))','((site_logo))');
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>
                                            {{__('message.job_application_status_change')}}
                                        ...
                                        <textarea rows="20" class="form-control" name="job_application_status_change" id="job_application_status_change">{!! settingEmp('job_application_status_change', true) !!}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                   <iframe src="{{route('uploads-view', employerPath().'/templates/job-application-status-change.html')}}" class="template-iframe"></iframe>
                                </div>                                
                                <div class="col-md-12">
                                    <hr />
                                </div>
...
<script src="{{url('cdn-employers')}}/js/cf/setting.js"></script>
@endsection