...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fas fa-cube"></i> {{ __('message.interview_categories') }}<small></small></h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/') }}/employer/dashboard"><i class="fas fa-tachometer-alt"></i> {{ __('message.home') }}</a></li>
            <li class="active"><i class="fas fa-clipboard-list"></i> {{ __('message.interviews') }}</li>
            <li class="active"><i class="fas fa-cube"></i> {{ __('message.interview_categories') }}</li>
        </ol>
    </section>
    <!-- Main content -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="datatable-top-controls datatable-top-controls-filter">
                                    @if(empAllowedTo('create_interview_categories'))
                                    <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-interview-category">
                                    <i class="fa fa-plus"></i> {{ __('message.add_interview_category') }}
                                    </button>
                                    @endif
                                    <div class="btn-group">
...
<script src="{{url('cdn-employers')}}/js/cf/interview_category.js"></script>
@endsection