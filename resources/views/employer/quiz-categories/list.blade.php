...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><i class="fas fa-cube"></i> {{ __('message.quiz_categories') }}<small></small></h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/') }}/employer/dashboard"><i class="fas fa-tachometer-alt"></i> {{ __('message.home') }}</a></li>
            <li class="active"><i class="far fa-list-alt"></i> {{ __('message.quizes') }}</li>
            <li class="active"><i class="fas fa-cube"></i> {{ __('message.quiz_categories') }}</li>
        </ol>
    </section>
    <!-- Main content -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="datatable-top-controls datatable-top-controls-filter">
                                    @if(empAllowedTo('create_quiz_categories'))
                                    <button type="button" class="btn btn-primary btn-blue btn-flat create-or-edit-quiz-category">
                                    <i class="fa fa-plus"></i> {{ __('message.add_quiz_category') }}
                                    </button>
                                    @endif
                                    <div class="btn-group">
...
<script src="{{url('cdn-employers')}}/js/cf/quiz_category.js"></script>
@endsection