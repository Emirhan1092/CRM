...
<div class="modal-body">
    ...
    <div class="accordion" id="accordionExample">
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <a class="pay-with-razorpay" href="#">
                    <img src="{{ url('/cdn-employers') }}/img/razorpay.png" />
                </a>
                <div class="razorpay-success-container"></div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <a class="pay-with-paystack" href="#">
                    <img src="{{ url('/cdn-employers') }}/img/paystack.png" />
                </a>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <a class="paypal-link" href="#">
                    <img src="{{ url('/cdn-employers') }}/img/paypal.png" />
                </a>
            </div>
        </div>
        <hr />
        @endif
        @if(setting('enable_flutterwave') == 'yes')
        <!-- Flutterwave Payment Start -->
        <div class="row">
            <div class="col-sm-12 text-center">
                <span class="payment-form-values">{{ __('message.pay_with') }} </span><br /><br />
                <input type="hidden" id="flutterwave-route" value="{{route('candidate-payment-flutterwave')}}">
                <a class="pay-with-flutterwave" href="#" target="_blank">
                    <img src="{{ url('/cdn-employers') }}/img/flutterwave.png" height="50" />
                </a>
                <div class="flutterwave-success-container"></div>
            </div>
        </div>
        <hr />
        <!-- Flutterwave Payment Start -->
        ...
        @if(setting('enable_mollie') == 'yes')
        <!-- Mollie Payment Start -->
        <div class="row">
            <div class="col-sm-12 text-center">
                <span class="payment-form-values">{{ __('message.pay_with') }} </span><br /><br />
                <input type="hidden" id="mollie-route" value="{{route('candidate-payment-mollie')}}">
                <a class="pay-with-mollie" href="#" target="_blank">
                    <img src="{{ url('/cdn-employers') }}/img/mollie.png" height="50" />
                </a>
                <div class="mollie-success-container"></div>
            </div>
        </div>
        <hr />
        <!-- Mollie Payment Start -->
