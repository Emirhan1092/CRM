									...
									<div class="row align-items-center">
										<div class="col-md-12 col-sm-12">
											<div class="section-profile-boxes-alpha-item-heading">
												@php $cname = $candidate['first_name'].' '.$candidate['last_name']; @endphp
												<a href="{{route('front-candidate-detail', ($candidate['slug'] ? $candidate['slug'] : encode($candidate['candidate_id'])))}}" title="{{$cname}}">
													<h2>{{ trimString($cname, 30) }}</h2>
												</a>
											</div>
