				...
				<div class="section-icon-boxes-alpha-item h-100">
					<div class="row align-items-center h-100">
						<div class="col-md-12 col-sm-12">
							...
							<div class="section-icon-boxes-alpha-item-heading" title="{{$comp['company']}}">
								<h2>{{trimString($comp['company'], 22)}}</h2>
							</div>
							<div class="section-icon-boxes-alpha-item-content">
								<p title="{{$comp['country'] .($comp['city'] ? ','.$comp['city'] : '')}} | {{$comp['industry_title']}}">
									<i class="fa-solid fa-location-dot"></i> {{trimString($comp['country'] .($comp['city'] ? ','.$comp['city'] : ''), 15)}} | <i class="fa-solid fa-industry"></i> {{trimString($comp['industry_title'], 10)}}
								</p>
							</div>
