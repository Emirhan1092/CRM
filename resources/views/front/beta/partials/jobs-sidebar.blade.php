			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="section-sidebar-beta-item-content">
					<ul>
						...
						<li>
							<label for="{{encode($dept['department_id'], false)}}" title="{{$dept['title']}}">
								{{trimString($dept['title'], 25)}}
							</label> 
							<input 
								class="jobs-department-check" 
			...
			<div class="section-sidebar-beta-item">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="section-sidebar-beta-item-heading">
						...
						<h3 title="{{$jf['title']}}">{{trimString($jf['title'], 25)}}</h3>
					</div>
					<div class="section-sidebar-beta-item-content">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<div class="section-sidebar-beta-item-content">
						<ul class="job-filter" data-id="{{ encode($jf['job_filter_id'], false) }}">
                            ...
                            @endphp							
							<li>
								<label for="{{slugify($jf['title']).'-'.$k}}" title="{{$jfv['title']}}">
									{{trimString($jfv['title'], 25)}}
								</label>
								<input 
									type="radio" 
									class="job-filter-check" 
