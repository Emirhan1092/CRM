...
class EmployersController extends Controller
{
    ...
    public function updateProfile(Request $request)
    {
		...
		$validator = Validator::make($request->all(), [
            ...
            'city' => [new MinString(2), new MaxString(100)],
            'state' => [new MinString(2), new MaxString(100)],
            'country' => [new MinString(2), new MaxString(100)],
            'address' => [new MinString(2), new MaxString(140)],
