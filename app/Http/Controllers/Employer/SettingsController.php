...
class SettingsController extends Controller
{
    ...
    public function updateGeneral(Request $request)
    {
        ...
        $rules["admin_email"] = ['required', 'email', new MaxString(100)];
        $rules["from_email"] = ['required', 'email', new MaxString(100)];
        $rules["jobs_per_page"] = ['required', 'numeric', new MaxString(100)];
        $rules["blogs_per_page"] = ['required', 'numeric', new MaxString(100)];
    ...
    public function updateEmails(Request $request)
    {
        ...
        $rules['job_application_status_change'] = "required|max:5000";
        ...
        $validator = Validator::make($request->all(), $rules, [
            ...
            'job_application_status_change.required' => __('validation.required'),
            'job_application_status_change.max' => __('validation.max_string'),
        ]);
        ...
        $data = array(
            ...
            'job_application_status_change' => templateInput('job_application_status_change'),
        );
    ...
    private function reservedWordsValidation($data)
    {
        ...
        $reservedWords = array('((first_name))','((last_name))','((job_title))', '((application_status))', '((site_link))','((site_logo))');
        if (checkReservedWords($reservedWords, $data['job_application_status_change'])) {
            $error .= __('message.these_words_are_reserved_in_template', array(
                'tags' => implode(', ',$reservedWords), 
                'template' => __('message.job_application_status_change')
            ));
        }
