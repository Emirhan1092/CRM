...
use App\Models\Employer\City;
use App\Models\Employer\Country;
use App\Models\Employer\State;
...
class JobsController extends Controller
{
    ...
    public function createOrEdit($job_id = NULL)
    {
        ...
        $data['departments'] = objToArr(Department::getAll());
        $data['positions'] = objToArr(Position::all());
        $data['sectors'] = objToArr(Industry::getAll());
        $data['countries'] = objToArr(Country::all());
        $data['states'] = objToArr(State::all());
        $data['cities'] = objToArr(City::all());
    ...
    public function save(Request $request)
    {
        ...
        $rules['description'] = ['required', new MinString(50), new MaxString(100000)];
