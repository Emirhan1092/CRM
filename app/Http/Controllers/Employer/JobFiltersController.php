...
class JobFiltersController extends Controller
{
    ...
    public function listView()
    {
        ...
        return view('employer.job-filters.list', $data);
    }
    ...
    public function createOrEdit($job_filter_id = NULL)
    {
        ...
        echo view('employer.job-filters.create-or-edit', compact('job_filter'))->render();
    }
    ...
    public function updateValuesForm($job_filter_id = NULL)
    {
        ...
        echo view('employer.job-filters.values', compact('values', 'job_filter_id'))->render();
    }
    ...
    {
        echo view('employer.job-filters.value')->render();
    }
    ...
    private function checkActiveJobFilters($id = '', $status = '')
    {
        ...
        $totalAllowedActiveFilters = empMembership(employerId(), 'active_custom_filters');
