...
class LanguagesController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        if ($edit) {
            $rules['title'] = ['required', new MinString(2), new MaxString(90), 'unique:languages,title,'.$edit.',language_id'];
        } else {
            $rules['title'] = ['required', new MinString(2), new MaxString(90), 'unique:languages'];
        }
    ...
    public function changeSelected($language_id = null)
    {
        ...
        $file = fopen(public_path().'/cdn-general/js/lang.js', "w");
