...
class SettingsController extends Controller
{
    ...
    public function updateDisplay(Request $request)
    {
        ...
        writeToFile(public_path('/cdn-front'.viewPrfx(true).'/css/custom-css.css'), $data['front_site_css']);
        writeToFile(public_path('/cdn-candidates'.viewPrfx(true).'/css/custom-css.css'), $data['candidate_site_css']);
