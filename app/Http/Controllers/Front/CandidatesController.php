...
{   
    ...
    public function updateProfile(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'city' => ['required', new MinString(2), new MaxString(140)],
            'country' => ['required', new MinString(2), new MaxString(140)],
            'dob' => 'required',
            'state' => ['required', new MinString(2), new MaxString(140)],
            'address' => ['required', new MinString(2), new MaxString(140)],
            'bio' => ['required', new MinString(2), new MaxString(50000)],
        ], [
    ...
    public function register(Request $request)
    {
        ...
        if (setting('enable_candidate_packages') == 'yes') {        
            ...
            $freePackage = objToArr(CandidatePackage::where('is_free', 1)->first());
            if (!$freePackage) {
                die(json_encode(array(
                    'success' => 'false',
