...
{   
    public function list(Request $request)
    {
        ...
        $data['departments'] = Department::where("parent", "=", 0)->get();
     ...
     * @return html/string
     */
    public function jobApplicationDelete($job_application_id)
    {
        Job::deleteJobApplication($job_application_id);
        return redirect(route('front-acc-job-apps'));
    }
