...
class ResumesController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'title' => ['required', new MinString(2), new MaxString(90)],
            'designation' => ['required', new MinString(2), new MaxString(90)],
        ], [
    ...
    public function updateGeneral(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'title' => ['required', new MinString(2), new MaxString(90)],
            'designation' => ['required', new MinString(2), new MaxString(90)],
            'objective' => ['required', new MinString(50), new MaxString(10000)],
        ], [
            'title.required' => __('validation.required'),
            'title.min' => __('validation.min_string'),
            'title.max' => __('validation.max_string'),
    ...
    public function updateExperience(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'company.*' => ['required', new MinString(2), new MaxString(90)],
            'description.*' => ['required', new MinString(50), new MaxString(50000)],
        ], [
            'title.required' => __('validation.required'),
            'title.min' => __('validation.min_string'),
            'title.max' => __('validation.max_string'),
    ...
    public function updateQualification(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'institution.*' => ['required', new MinString(2), new MaxString(90)],
    ...
    public function updateReference(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'title.*' => ['required', new MinString(2), new MaxString(90)],
            'relation.*' => ['required', new MinString(2), new MaxString(90)],
            'email.*' => ['required', new MinString(2), new MaxString(90), 'email'],
            'company.*' => ['required', new MinString(2), new MaxString(90)],
            'phone.*' => ['required', new MinString(7), new MaxString(20)],
        ], [
            'title.required' => __('validation.required'),
            'title.min' => __('validation.min_string'),
            'title.max' => __('validation.max_string'),
