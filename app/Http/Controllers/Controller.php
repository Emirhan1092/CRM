...
class Controller extends BaseController
{
     ...
     * @return void
     */
    public function sendEmail($message = '', $toEmail = '', $subject = '', $employer = 0, $storeForCron = '')
    {
        $storeForCron = $storeForCron ? $storeForCron : setting('enable_emails_cron');
        if ($storeForCron == 'yes') {
            $email = array(
