...
class Setting extends Model
{
    ...
    {   
        ...
        writeToFile(public_path('/cdn-front'.viewPrfx(true).'/css/variables.css'), $cssVars);
        ...
        //Writing to file and update in db setting
        writeToFile(public_path('/cdn-candidates'.viewPrfx(true).'/css/variables.css'), $cssVars2);
