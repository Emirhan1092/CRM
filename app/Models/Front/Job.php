...
class Job extends Model
{
    ...
    public static function getAll($r)
    {
        ...
        if (setting('display_jobs_front') == 'employers_without_separate_site' && env('BFCRM_DEMO') == false) {
    ...
    public static function deleteJobApplication($job_application_id)
    {
        $data['job_application_id'] = decode($job_application_id);
        $data['candidate_id'] = candidateSession();
        DB::table('job_applications')->where($data)->delete();
        DB::table('job_traite_answers')->where($data)->delete();
    }
