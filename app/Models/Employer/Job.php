...
class Job  extends Model
{
    ...
    public static function storeJob($data, $edit = null)
    {
        ...
        $data['industry_id'] = decode($data['industry_id']);
        $data['position_id'] = decode($data['position_id']);
        ...
        $data['languages'] = isset($data['languages']) ? implode(",", $data['languages']) : array();
        $data['gender'] = isset($data['gender']) ? $data['gender'] : 'none';
        $data['salary_currency'] = isset($data['salary_currency']) ? $data['salary_currency'] : '';
