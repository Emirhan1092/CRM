function Account() {
    ...
    this.initDeleteJobApplication = function () {
        $('.delete-job-application').off();
        $('.delete-job-application').on('click', function(e) {
            e.preventDefault();
            var status = confirm(lang['are_u_sure']);
            if (status === true) {
    ...
    this.initMembershipRenewForm = function () {
        ...
        $('.renew-membership').on('click', function () {
            ...
            application.load('/account/membership/renew', modal+' .modal-body-container', function (result) {
                ...
                self.initFlutterwavePayment();
                self.initMolliePayment();                
    ...
    this.initFlutterwavePayment = function () {
        $('.pay-with-flutterwave').off();       
        $('.pay-with-flutterwave').on('click', function(e) {
            e.preventDefault();
            var route = $('#flutterwave-route').val();
            var selected = $('input[name=selected_package]:checked').val();
            window.location = route+'/'+selected;
        });
    }

    this.initMolliePayment = function () {
        $('.pay-with-mollie').off();       
        $('.pay-with-mollie').on('click', function(e) {
            e.preventDefault();
            var route = $('#mollie-route').val();
            var selected = $('input[name=selected_package]:checked').val();
            window.location = route+'/'+selected;
        });
    }    
...
$(document).ready(function() {
    ...
    account.initDeleteJobApplication();
